...
async function main() {
    ...
    console.log(chalk.green(figlet.textSync('Project Creator', { horizontalLayout: 'full' })));
    console.log(chalk.cyan(`This tool will help you create projects based on your selected category and technology.\n`));
    ...
    switch (category) {
        case 'web':
            await createWebProject({ technology: technology.technology, projectName });
            break;
        case 'database':
            await createDatabaseProject({ technology: technology.technology, projectName });
            break;
        case 'backend':
            await createBackendProject({ technology: technology.technology, projectName });
            break;
        case 'mobile':
            await createMobileProject({ technology: technology.technology, projectName });
            break;
    }
}
