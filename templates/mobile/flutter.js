...
export function createFlutterProject(projectName) {
    ...
    try {
        ...
        console.log(chalk.green(`   Start available emulator: flutter emulators --launch <emulator_id>`));
        console.log(chalk.green(`   List available emulators: flutter emulators`));
        ...
        console.log(chalk.green(`     - Or use Flutter: flutter emulators --launch apple_ios_simulator`));
        ...
        console.log(chalk.green(`     - Or use Flutter: flutter emulators --launch <android_emulator_id>`));
        console.log(chalk.green(`\n🔧 Additional commands:`));
