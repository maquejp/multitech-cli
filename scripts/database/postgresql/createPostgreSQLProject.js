...
export default async function ({ projectName }) {
  console.log(`Creating a PostgreSQL database project named ${projectName}...`);
  ...
  try {
    ...
    const envContent = `POSTGRES_USER=postgresqladmin
...
POSTGRES_PORT=5432`;
    ...
    console.log("\nPostgreSQL project created successfully!");
    console.log("\nNext steps:");
    ...
    console.log("4. Access the database at localhost:5432");
  } catch (error) {
    console.error("Error creating PostgreSQL project:", error);
    process.exit(1);
  }
}
